...
const generateFooterLinkText = (text: string) => {
  return (
    <>
      {text}
      <Vercel />
...
export const i18nConfig: i18nConfigType = {
  en: {
    ...
    footerLinkElement: generateFooterLinkText('Powered by Vercel'),
  },
  es: {
    ...
    footerLinkElement: generateFooterLinkText('Desarrollado por Vercel'),
  },
  ru: {
    title: 'React хуки для выборки данных',
    editText: 'Редактировать на GitHub',
    footerLinkText: 'https://vercel.com/?utm_source=swr_ru',
    footerLinkElement: generateFooterLinkText('Работает на Vercel'),
  }
}
